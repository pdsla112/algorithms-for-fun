...
public class StrandSortTest {
    ...
    public <T extends Comparable<T>> void testStrandSortEmpty() {
        ...
        List<T> sorted = strandSort.strandSort(unsorted);  // You needed a Comparable to be extended as this method implies that unsorted is comparable, but here you don't have that declaration, so it's very ambiguous for Java.
